export const HomeIcon = ({ activeProp }: { activeProp: boolean }) => {
  const iconColor = activeProp === true ? "rgba(72,220,164,255)" : "white";
...
export const TransactionIcon = ({ activeProp }: { activeProp: boolean }) => {
...
export const FoodIcon = ({ activeProp }: { activeProp: boolean }) => {
  const iconColor = activeProp === true ? "rgba(72,220,164,255)" : "white";
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
